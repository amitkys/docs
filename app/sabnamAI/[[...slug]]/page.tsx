import { getPageImage, sabnamAISource } from '@/lib/source';
...
export default async function Page(props: PageProps<'/sabnamAI/[[...slug]]'>) {
  ...
  const page = sabnamAISource.getPage(params.slug);
  if (!page) notFound();
      ...
      <DocsBody>
        <MDX
          components={getMDXComponents({
            ...
            a: createRelativeLink(sabnamAISource, page),
          })}
        />
      </DocsBody>
    </DocsPage>
...
export async function generateStaticParams() {
  return sabnamAISource.generateParams();
}
